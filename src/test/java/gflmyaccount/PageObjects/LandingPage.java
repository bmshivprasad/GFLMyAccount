...
public class LandingPage extends EnhancedBaseClass {
    ...
    @FindBy(xpath = "(//div[contains(text(),'SERVICE ORDERS')])[1]")
    ...
    @FindBy(xpath = "//mat-nav-list//div[text()='HOME ']")
    WebElement lnkHome;
    ...
    public void openPenal()
    {
        ...
        if(generics.isPresent(lnkHome))
        {
            testStepsLog("Panel is open");
        }
        else
        {
            generics.clickOn(btnMenu);
        }
    }
    ...
    public void OpenUsers() {
        generics.pause(1);
        generics.clickOn(Users);
        testStepsLog("Click on Users link ");
        generics.pause(2);
    }
