...
import gflmyaccount.testcases.SignUp;
...
public class SignUpPage extends SignUp implements gflmyaccount.utilities.ExcelColumns {
    ...
    public void clickonAddProspectButton() {
        generics.pause(10);
        generics.waitForElementVisible(btnAddProspect);
        generics.moveTo(btnAddProspect);
    ...
    @FindBy(xpath = "//span[text()='New Prospect']")
    ...
    public void selectBusinessUnit1(int row) {
        generics.pause(3);
        String BU = excelUtils.getTestData(SignUp, row, 4);
    ...
    public void selectSalesRep() {
        ...
        if(generics.isPresent(dpRepOption)) {
...
//        js.executeScript("window.scrollTo(0, document.body.scrollHeight)");
    ...
    public void SelectbillToCustomerBillingAddress() {
        generics.moveTo(chkbillToCustomerBillingAddress);
    ...
    public void SelectSiteContactSameAsPrimaryContact() {
        generics.moveTo(chkbSitecontactsameasprimarycontact);
    ...
    public void clickonAddNewServiceButton() {
        ...
        generics.pause(6);
        generics.waitForElementVisible(btnAddnewServices);
        //JavascriptExecutor js = (JavascriptExecutor) localDriver;
        //js.executeScript("window.scrollTo(0, document.body.scrollHeight)");
        generics.moveTo(Aggreement);
...
//      generics.moveTo("//div[@class='card_title'][contains(.,'DISPOSAL')]")));
    ...
    @FindBy(xpath = "//h2[contains(text(),'Are you sure you have attached all the necessary')]")
    ...
    public void clickonSubmit() {
        ...
        {
            generics.testStepsLog("No Submit button found");
        }
    }
    ...
    public void typeServiceLineItem() {
        int Servicelineitem = generics.getRandomBetween(1, 99999);
    ...
    @FindBy(xpath ="//mat-checkbox[@formcontrolname='isChecked'][last()]")
    public WebElement chkOthers;
    ...
    public void typeTruxCustomerNo() {
        ...
        generics.moveTo(txtTruxcustomerno);
        generics.moveTo(chkOthers);
    ...
    @FindBy(xpath = "(//div[@class='card_title'])[1]")
    WebElement regions;
    ...
    @FindBy(xpath = "(//h3[text()='MY SERVICE ZONES']/../following-sibling::div/p)[1]")
    ...
    public void clickonTempServicebtn() {
        ...
        generics.waitForElementVisible(btntempServices);
    ...
    @FindBy(xpath = "//span[text()=' BFI Canada - Brampton Transfer ']")
    public WebElement BFISite;

    public void selectDesposibleSite() {

        generics.clickOn(dpDesposibleSite);
        if(generics.isPresent(BFISite))
            generics.clickOn(BFISite);
        else
            generics.clickOn(firstOption);
